...
class User(AbstractUser):
    ...
    self_invite = models.CharField(max_length=6, verbose_name='инвайт код', unique=True, **NULLABLE)
    received_invite = models.ForeignKey('self', on_delete=models.CASCADE, verbose_name='полученный инвайт код', **NULLABLE)
