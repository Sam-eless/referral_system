    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_code', models.SmallIntegerField(blank=True, null=True, verbose_name='код подтверждения')),
                ('self_invite', models.CharField(blank=True, max_length=6, null=True, unique=True, verbose_name='инвайт код')),
                ...
                ('received_invite', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='полученный инвайт код')),
